...
function currentCd(X::StateVector, Cd::Array{Float64})
    ...
    for i in 1:(size(Cd)[1])             #length(Cd)/2 pois o Cd é uma matriz n por 2 (n linha e 2 colunas) e o comprimento dessa matriz seria 2n, e queremos percorrer apenas as linhas (n linhas) 
