function [deltat, T, X, rocket, prop, trilho] = flightbi(plot_logical, stepsize)

    % Dalton Felipe de Menezes AESP 15
    % ITA Rocket Design
    % Última versão: 2015-09-04 
    % Adaptado para o 6DOF do peixoto em 06/08/2019
    % Adicionado opções para empuxo e CD constantes em 07/09/2019
    ...
    dyna = {@dyna_rail  , @dyna_thrusted, @dyna_ballistic, ...
            @dyna_drogue, @dyna_main};
